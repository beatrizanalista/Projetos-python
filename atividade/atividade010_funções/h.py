...
# Faça um programa que pergunte a cada um dos clientes da academia seu código, nome, altura e peso. Após esse cadastramento, seu programa deverá listar os dados dos clientes e a média. 
